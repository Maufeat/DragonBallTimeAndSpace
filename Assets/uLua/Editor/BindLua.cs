...
public static class LuaBinding
{
    ...
    [MenuItem("Tools/Lua/Gen Lua Wrap Files", false, 11)]
    ...
    static void GenLuaBinder()
    {
        ...
        if (AppConst.AutoWrapMode) {
            string wrapfile = AppConst.uLuaScriptPath + "/System/Wrap.lua";
        ...
        string file = AppConst.uLuaInternalPath + "/Source/Base/LuaBinder.cs";
    ...
    [MenuItem("Tools/Lua/Clear Lua Wrap Files", false, 13)]
    public static void ClearLuaBinder()
    {
        ...
        ClearFiles(AppConst.uLuaInternalPath + "/Source/LuaWrap/");
        AssetDatabase.Refresh();
    }
    ...
    /// 编码LUA文件用UTF-8
    /// </summary>
    [MenuItem("Tools/Lua/Encode LuaFile with UTF-8", false, 50)]
    ...
    [MenuItem("Tools/Lua/Build Lua without jit", false, 4)]
