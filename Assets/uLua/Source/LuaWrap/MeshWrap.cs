...
public class MeshWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("SetVertices", SetVertices),
			new LuaMethod("SetNormals", SetNormals),
			new LuaMethod("SetTangents", SetTangents),
			new LuaMethod("SetUVs", SetUVs),
			new LuaMethod("GetUVs", GetUVs),
			...
			new LuaMethod("GetBlendShapeFrameCount", GetBlendShapeFrameCount),
			new LuaMethod("GetBlendShapeFrameWeight", GetBlendShapeFrameWeight),
			new LuaMethod("GetBlendShapeFrameVertices", GetBlendShapeFrameVertices),
			new LuaMethod("ClearBlendShapes", ClearBlendShapes),
			new LuaMethod("AddBlendShapeFrame", AddBlendShapeFrame),
	...
	static int SetUVs(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(int), typeof(List<Vector4>)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(int), typeof(List<Vector3>)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
			int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			List<Vector3> arg1 = (List<Vector3>)LuaScriptMgr.GetLuaObject(L, 3);
			obj.SetUVs(arg0,arg1);
			return 0;
		}
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(int), typeof(List<Vector2>)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
			int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			List<Vector2> arg1 = (List<Vector2>)LuaScriptMgr.GetLuaObject(L, 3);
			obj.SetUVs(arg0,arg1);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Mesh.SetUVs");
		}
	...
	static int GetUVs(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Mesh.GetUVs");
		}
	...
	static int SetColors(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(List<Color32>)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
			List<Color32> arg0 = (List<Color32>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.SetColors(arg0);
			return 0;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(List<Color>)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
			List<Color> arg0 = (List<Color>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.SetColors(arg0);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Mesh.SetColors");
		}
	...
	static int SetTriangles(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(List<int>), typeof(int)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
			List<int> arg0 = (List<int>)LuaScriptMgr.GetLuaObject(L, 2);
			int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
			obj.SetTriangles(arg0,arg1);
			return 0;
		}
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Mesh), typeof(int[]), typeof(int)))
		{
			Mesh obj = (Mesh)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Mesh");
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Mesh.SetTriangles");
		}
	...
	static int GetBlendShapeFrameVertices(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		Vector3[] objs2 = LuaScriptMgr.GetArrayObject<Vector3>(L, 4);
		Vector3[] objs3 = LuaScriptMgr.GetArrayObject<Vector3>(L, 5);
		Vector3[] objs4 = LuaScriptMgr.GetArrayObject<Vector3>(L, 6);
		obj.GetBlendShapeFrameVertices(arg0,arg1,objs2,objs3,objs4);
		return 0;
	}
	...
	static int AddBlendShapeFrame(IntPtr L)
	{
		...
		Vector3[] objs3 = LuaScriptMgr.GetArrayObject<Vector3>(L, 5);
		Vector3[] objs4 = LuaScriptMgr.GetArrayObject<Vector3>(L, 6);
		obj.AddBlendShapeFrame(arg0,arg1,objs2,objs3,objs4);
		return 0;
	}
