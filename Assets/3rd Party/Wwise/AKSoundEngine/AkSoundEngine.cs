// dnSpy decompiler from Assembly-CSharp.dll class: AkSoundEngine
using System;
...
public class AkSoundEngine
{
	...
	public static AKRESULT PrepareEvent(AkPreparationType in_PreparationType, string[] in_ppszString, uint in_uNumEvent)
	{
		...
		try
		{
			result = (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_0((int)in_PreparationType, intPtr, in_uNumEvent);
		}
		finally
		{
	...
	public static AKRESULT PrepareEvent(AkPreparationType in_PreparationType, string[] in_ppszString, uint in_uNumEvent, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		...
		try
		{
			result = (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_2((int)in_PreparationType, intPtr, in_uNumEvent, IntPtr.Zero, (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	public static AKRESULT PrepareGameSyncs(AkPreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string[] in_ppszGameSyncName, uint in_uNumGameSyncs)
	{
		...
		try
		{
			result = (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_0((int)in_PreparationType, (int)in_eGameSyncType, in_pszGroupName, intPtr, in_uNumGameSyncs);
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	public static AKRESULT PrepareGameSyncs(AkPreparationType in_PreparationType, AkGroupType in_eGameSyncType, string in_pszGroupName, string[] in_ppszGameSyncName, uint in_uNumGameSyncs, AkCallbackManager.BankCallback in_pfnBankCallback, object in_pCookie)
	{
		...
		try
		{
			result = (AKRESULT)AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_2((int)in_PreparationType, (int)in_eGameSyncType, in_pszGroupName, intPtr, in_uNumGameSyncs, IntPtr.Zero, (in_pCookie == null) ? IntPtr.Zero : ((IntPtr)in_pCookie.GetHashCode()));
		}
		finally
		{
			Marshal.FreeHGlobal(intPtr);
	...
	public static AKRESULT QueryReflectionPaths(GameObject in_gameObjectID, AkVector out_listenerPos, AkVector out_emitterPos, AkReflectionPathInfoArray out_aPaths, out uint io_uArraySize)
	{
		ulong akGameObjectID = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
		AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryReflectionPaths(akGameObjectID, AkVector.getCPtr(out_listenerPos), AkVector.getCPtr(out_emitterPos), out_aPaths.GetBuffer(), out io_uArraySize);
	}
	...
	public static AKRESULT SetEmitterObstructionAndOcclusion(GameObject in_gameObjectID, float in_fObstruction, float in_fOcclusion)
	{
		ulong akGameObjectID = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
		AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetEmitterObstructionAndOcclusion(akGameObjectID, in_fObstruction, in_fOcclusion);
	}
	...
	public static AKRESULT QueryIndirectPaths(GameObject in_gameObjectID, AkPathParams arg1, AkReflectionPathInfoArray paths, uint numPaths)
	{
		ulong akGameObjectID = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
		AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryIndirectPaths(akGameObjectID, AkPathParams.getCPtr(arg1), paths.GetBuffer(), numPaths);
	}
	...
	public static AKRESULT QuerySoundPropagationPaths(GameObject in_gameObjectID, AkPathParams arg1, AkPropagationPathInfoArray paths, uint numPaths)
	{
		ulong akGameObjectID = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
		AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QuerySoundPropagationPaths(akGameObjectID, AkPathParams.getCPtr(arg1), paths.GetBuffer(), numPaths);
	}
	...
	public static AKRESULT QueryDiffractionPaths(GameObject in_gameObjectID, AkPathParams arg1, AkDiffractionPathInfoArray paths, uint numPaths)
	{
		ulong akGameObjectID = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
		AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectID);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_QueryDiffractionPaths(akGameObjectID, AkPathParams.getCPtr(arg1), paths.GetBuffer(), numPaths);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetGeometry(in_GeomSetID, Triangles.GetBuffer(), NumTriangles, Vertices.GetBuffer(), NumVertices, Surfaces.GetBuffer(), NumSurfaces, EnableDiffraction, EnableDiffractionOnBoundaryEdges);
	}
	...
	public static AkSoundEngine.GameObjectHashFunction GameObjectHash
	{
		set
		{
			AkSoundEngine.gameObjectHash = ((value != null) ? value : new AkSoundEngine.GameObjectHashFunction(AkSoundEngine.InternalGameObjectHash));
		}
	}
